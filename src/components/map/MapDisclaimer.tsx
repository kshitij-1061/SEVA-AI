  ...
  return (
    <div className="bg-indigo-50/90 border border-indigo-200/80 p-3 rounded-2xl text-xs text-indigo-950 flex items-start gap-2.5 shadow-2xs">
      ...
      <div className="space-y-0.5">
        <span className="font-bold text-indigo-950 block">Demo Civic Map</span>
        <p className="text-[11px] text-indigo-800 leading-relaxed font-normal">
          Map markers shown in this prototype use demonstration and citizen-submitted data. OpenStreetMap tiles are provided for visualization purposes.
        </p>
      </div>
    </div>
  );
